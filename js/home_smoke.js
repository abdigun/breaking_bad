...
// clarification this smoke is not my work, i only tweak a bit .
// credit goes to  https://codepen.io/Perhelion/pen/QRNjgZ
/* smoke.js */
...
class Smoke {
  ...
  init() {
    ...
    $('.hm-intro').append(renderer.domElement);
  }
 ...
 // 
  addBackground() {
    ...
    textureLoader.setCrossOrigin('anonymous')
    textureLoader.load('https://i.imgur.com/95DrEMD.png', texture => {
